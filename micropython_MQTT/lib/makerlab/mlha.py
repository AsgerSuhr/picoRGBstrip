...
class MLHA:
    def __init__(self, wifi_ssid, wifi_password, mqtt_server, mqtt_port=1883, mqtt_user=None, mqtt_password=None, mqtt_keepalive=1800, name='picoW'):
        ...
        self.pico_id = "picoW-" + ubinascii.hexlify(machine.unique_id()).decode()
    ...
    def publish_config(self, discovery_topic, name, device_type="sensor", device_class=None, unit_of_measurement=None, state_class=None):
        ...
        if device_type == "switch":
            ...
            # self.subscribe("/switch/toggle/" + discovery_topic)
            config_payload["payload_on"] = True
            config_payload["payload_off"] = False
        ...
        if device_type == "light":
            ...
            config_payload["command_topic"] = f'{self.pico_id}/{device_type}/{discovery_topic}'
            config_payload['brightness'] = True
            config_payload['color_mode'] = True
            config_payload['supported_color_modes'] = ["rgb"]
